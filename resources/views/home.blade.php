            ...
            <div class="row gap-5">
                ...
                <div class="col">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="number_one" name="number_one" value="0">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control" id="number_two" name="number_two" value="100">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="number_exercises" name="number_exercises" value="10">
                    </div>
